...
# a function to generate a single-run, line-by-line test the model (not part of the final model run)
...
We first make a scenario file, for which we use evapotranspiration data for 1980 to 2009.
