...
Fig_baseline_crop_water_gap <- decisionSupport::plot_distributions(mcSimulation_object = plotting_simulations,
                                    vars = c("scen1_crop_water_gap"), #annual
                                    method = 'smooth_simple_overlay',
                                    x_axis_name = expression(atop("Annual crop water gap", 
                                                                  paste("(% of needed irrigation water)"))),
                                    y_axis_name = "Distribution density",
                                    base_size = 13) + 
...
Fig_environmental_eflow_policy_effect_crop_water_gap <- decisionSupport::plot_distributions(mcSimulation_object = plotting_simulations,
                                    vars = c("Mean_Crop_water_gap_difference_2_vs_1"),
                                    method = 'smooth_simple_overlay',
                                    x_axis_name = expression(atop("Crop water gap change", paste("through environmental e-flows (perc. points)"))),
                                    y_axis_name = "Distribution density",
...
library(patchwork)
 ...
 Fig_environmental_eflow_policy_effect_crop_water_gap + 
   Fig_monthly_env_eflow_increase_crop_water_gap +
   plot_layout(guides = "collect") + 
   plot_annotation(title = "Environmental eflows scenario")

  # plot_annotation(tag_levels = 'a') +
# guides = "collect"

ggsave("figures/environmental_eflow.png", width=10, height=5)
...
Fig_livelihoods_eflow_policy_effect_crop_water_gap <- decisionSupport::plot_distributions(mcSimulation_object = plotting_simulations,
                                    ...
                                    base_size = 13) + 
                                    theme(legend.position = "none") + 
                                    labs(x = expression(atop("Crop water gap change", 
                                            paste("through livelihoods e-flows (percentage points)"))))
...
Fig_livelihoods_eflow_policy_effect_crop_water_gap +
  Fig_monthly_env_eflow_increase_crop_water_gap + 
