...
# run the model with the scenario_mc function (a monte carlo with data from the scenarios for some inputs)
...
Here's the difference between the crop water gap in eflow scenario 2 vs. the baseline (no eflows)
