...
```{r plot_crop_needs-dist, include = F}

plotting_simulations <- mcSimulation_results 

Fig_total_annual_crop_water_irrigation_need <- decisionSupport::plot_distributions(mcSimulation_object = plotting_simulations,
...
plot_baseline_results <- Fig_total_annual_crop_water_irrigation_need +
...
Fig_baseline_crop_water_gap <- decisionSupport::plot_distributions(mcSimulation_object = plotting_simulations,
                                    ...
                                    method = 'smooth_simple_overlay',
                                    x_axis_name = expression(atop("Annual crop water gap", paste("(% of needed irrigation water)"))),
                                    y_axis_name = "Distribution density",
...
Fig_monthly_baseline_crop_water_gap <- plot_cashflow(mcSimulation_object = plotting_simulations, 
              ...
              y_axis_name = "a",
              x_axis_name = "Month", 
              facet_labels = "") + labs(y = expression("Monthly crop water gap (%)"))
...
Fig_8_environmental_eflow_policy_effect_crop_water_gap <- decisionSupport::plot_distributions(mcSimulation_object = plotting_simulations,
...
Fig_9_monthly_env_eflow_increase_crop_water_gap <- plot_cashflow(mcSimulation_object = plotting_simulations, 
...
Fig_10_monthly_change_in_downstream_river_flow_env_eflows <- plot_cashflow(mcSimulation_object = plotting_simulations, 
              cashflow_var_name = "Downstream_difference_2_vs_1",
              y_axis_name = "a",
              x_axis_name = "Month", 
              facet_labels = "") + 
  labs(y = expression(Downstream~river~flow~change, paste(~(m^3))))
...
library(patchwork)
 ...
 Fig_8_environmental_eflow_policy_effect_crop_water_gap | 
   (Fig_9_monthly_env_eflow_increase_crop_water_gap /
 Fig_10_monthly_change_in_downstream_river_flow_env_eflows) +
   plot_layout(ncol = 1, guides = "collect") + 
   plot_annotation(title = "eflows scenario")

  # plot_annotation(tag_levels = 'a') +
# guides = "collect"

ggsave("figures/test.png", width=10, height=5)
...
Fig_11_livelihoods_eflow_policy_effect_crop_water_gap <- decisionSupport::plot_distributions(mcSimulation_object = plotting_simulations,
...
```{r livelihoods-flow, include = F}
Fig_13_monthly_change_in_downstream_river_flow_live_eflows <- plot_cashflow(mcSimulation_object = plotting_simulations, 
